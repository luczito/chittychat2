...
func (x *chatConnectClient) Send(m *ClientMsg) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chatConnectClient) Recv() (*ServerMsg, error) {
	m := new(ServerMsg)
...
func (x *chatConnectServer) Send(m *ServerMsg) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chatConnectServer) Recv() (*ClientMsg, error) {
	m := new(ClientMsg)
